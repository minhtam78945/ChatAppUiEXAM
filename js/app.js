import {
    fetchConversation, fetchAllConversation, fetchUserById, fetUsersByName, unFriendRequest, addFriendRequest,
    unRequestAddFriend, aceeptResquest, unAcceptRequest, getCurrentUserData, getTimeElapsed, addDocument
...
function renderFriend(friend) {
    ...
    friendLastActive.appendChild(document.createTextNode(getTimeElapsed(friend.lastLoginAt)));
...
function displayChats() {
    ...
    fetchAllConversation()
        .then(friendChatList => {
            ...
            if (friendChatList.includes(friend.id)) {
                ///mo chat cu
            } else {
                // tao chat moi
...
function openConversation(friend) {
    ...
    document.getElementById('conversationTitle').innerHTML = friend.name;
